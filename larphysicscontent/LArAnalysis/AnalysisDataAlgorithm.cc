...
StatusCode AnalysisDataAlgorithm::Run()
{
    ...
    for (const ParticleFlowObject *const pPfo : pfoList)
    {
        ...
        {
            this->RecursivelyProduceEnergyFromRangeData(pPfo, fittedTrackInfoMap, mcParticleMap, m_pEnergyFromRangeProtonDataNtuple, {PROTON});

            this->RecursivelyProduceEnergyFromRangeData(
                pPfo, fittedTrackInfoMap, mcParticleMap, m_pEnergyFromRangePionMuonDataNtuple, {PI_PLUS, PI_MINUS, MU_MINUS});
        }
...
bool AnalysisDataAlgorithm::ProduceBirksFitData(const ParticleFlowObject *const pPfo,
    const LArAnalysisParticleHelper::FittedTrackInfoMap &fittedTrackInfoMap, const MCParticleMap &mcParticleMap) const
{
...
StatusCode AnalysisDataAlgorithm::ReadSettings(const TiXmlHandle xmlHandle)
{
    ...
    PANDORA_RETURN_RESULT_IF_AND_IF(
        STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=, XmlHelper::ReadValue(xmlHandle, "ProduceBirksFitData", m_produceBirksFitData));
    ...
    if (m_produceEnergyFromRangeData)
    {
        ...
        m_pEnergyFromRangePionMuonDataNtuple = new TNtuple("EnergyFromRangeDataPionsMuons", "EnergyFromRangeDataPionsMuons", "Range:TrueEnergy");
    }
