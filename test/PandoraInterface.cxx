/**
 *  @file   LArPhysicsContent/test/PandoraInterface.cc
 *
...
using namespace lar_physics_content;
...
#ifdef MONITORING
        TApplication *pTApplication = new TApplication("LArPhysicsContent", &argc, argv);
...
const Pandora *CreateNewPandora()
{
    ...
    PANDORA_THROW_RESULT_IF(STATUS_CODE_SUCCESS, !=, LArPhysicsContent::RegisterAlgorithms(*pPandora));
...
bool ParseCommandLine(int argc, char *argv[], Parameters &parameters)
{
    ...
    {
        std::cout << "LArPhysicsContent, stitching settings file must be provided, number of drift volumes: " << parameters.m_nDriftVolumes << std::endl << std::endl;
        return PrintOptions();
    }
...
bool ProcessRecoOption(const std::string &recoOption, Parameters &parameters)
{
    ...
    {
        std::cout << "LArPhysicsContent, Unrecognized reconstruction option: " << recoOption << std::endl << std::endl;
        return PrintOptions();
    }
