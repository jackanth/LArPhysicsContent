...
inline TCanvas * PlotNtuple1D(TNtuple *const pNtuple, const char *const xName, const char *const identifier,
                              const PlotSettings1D &plotSettings)
{
    float x = 0.f;
...
{    
    ...
    if (plotSettings.newCanvas)
    {
        switch (plotSettings.plotType)
        {
            case SAME:    pGraph->Draw("SAME"); break;
            case SCATTER: pGraph->Draw("AP");   break;
            case LINE:
    ...
    else
    {
        ...
        {
            case SAME:    pGraph->Draw("SAME"); break;
            case SCATTER: pGraph->Draw("P");    break;
            case LINE:
