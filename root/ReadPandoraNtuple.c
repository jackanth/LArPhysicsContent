...
void ReadPandoraNtuple(const char *const inputFilePath)
{
    ...
    typedef std::vector<std::uint64_t> UInt64Vector;
    typedef std::vector<std::string>   StringVector;
    typedef std::vector<unsigned>      UnsignedVector;
    
    TTree *const pTree = LoadTreeFromFile(inputFilePath, "PandoraTree");
    
    bool           nu_WasReconstructed                                    = false;
    bool           nu_IsVertexFiducial                                    = false;
    bool           nu_IsContained                                         = false;
    float          nu_FiducialHitFraction                                 = 0.f;
    bool           nu_HasMcInfo                                           = false;
    float          nu_VisibleEnergy                                       = 0.f;
    float          nu_VisibleLongitudinalEnergy                           = 0.f;
    float          nu_VisibleTransverseEnergy                             = 0.f;
    float          nu_VisibleEnergyFracFromRange                          = 0.f;
    float          nu_VisibleEnergyFracFromCorrectedTrackCharge           = 0.f;
    float          nu_VisibleEnergyFracFromUncorrectedTrackCharge         = 0.f;
    float          nu_VisibleEnergyFracFromShowerCharge                   = 0.f;
    float          nu_VertexX                                             = 0.f;
    float          nu_VertexY                                             = 0.f;
    float          nu_VertexZ                                             = 0.f;
    float          nu_DirectionCosineX                                    = 0.f;
    float          nu_DirectionCosineY                                    = 0.f;
    float          nu_DirectionCosineZ                                    = 0.f;
    std::string   *p_nu_TypeTree                                          = nullptr;
    unsigned       nu_NumberOf3dHits                                      = 0U;
    unsigned       nu_NumberOfCollectionPlaneHits                         = 0U;
    unsigned       nu_NumberOfDownstreamParticles                         = 0U;
    Long64_t       nu_mc_McParticleUid                                    = 0LL;
    float          nu_mc_Energy                                           = 0.f;
    float          nu_mc_LongitudinalEnergy                               = 0.f;
    float          nu_mc_TransverseEnergy                                 = 0.f;
    float          nu_mc_VisibleEnergy                                    = 0.f;
    float          nu_mc_VisibleLongitudinalEnergy                        = 0.f;
    float          nu_mc_VisibleTransverseEnergy                          = 0.f;
    float          nu_mc_VertexX                                          = 0.f;
    float          nu_mc_VertexY                                          = 0.f;
    float          nu_mc_VertexZ                                          = 0.f;
    float          nu_mc_DirectionCosineX                                 = 0.f;
    float          nu_mc_DirectionCosineY                                 = 0.f;
    float          nu_mc_DirectionCosineZ                                 = 0.f;
    float          nu_mc_Momentum                                         = 0.f;
    float          nu_mc_MomentumX                                        = 0.f;
    float          nu_mc_MomentumY                                        = 0.f;
    float          nu_mc_MomentumZ                                        = 0.f;
    bool           nu_mc_IsVertexFiducial                                 = false;
    bool           nu_mc_IsContained                                      = false;
    float          nu_mc_ContainmentFraction                              = 0.f;
    std::string   *p_nu_mc_TypeTree                                       = nullptr;
    std::string   *p_nu_mc_InteractionType                                = nullptr;
    bool           nu_mc_IsChargedCurrent                                 = false;
    float          nu_mc_VisibleEnergyFraction                            = 0.f;
    int            nu_mc_PdgCode                                          = 0;
    float          nu_mc_HitPurity                                        = 0.f;
    float          nu_mc_HitCompleteness                                  = 0.f;
    float          nu_mc_CollectionPlaneHitPurity                         = 0.f;
    float          nu_mc_CollectionPlaneHitCompleteness                   = 0.f;
    unsigned       primary_Number                                         = 0U;
